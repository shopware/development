...
mysqldump --column-statistics='0' '__DB_NAME__' -u '__DB_USER__' -p'__DB_PASSWORD__' -h '__DB_HOST__' --port='__DB_PORT__' | mysql '__DB_NAME___test' -u '__DB_USER__' -p'__DB_PASSWORD__' -h '__DB_HOST__' --port='__DB_PORT__'
...
mysqldump --column-statistics='0' '__DB_NAME__' -u '__DB_USER__' -p'__DB_PASSWORD__' -h '__DB_HOST__' --port='__DB_PORT__' | mysql '__DB_NAME___e2e' -u '__DB_USER__' -p'__DB_PASSWORD__' -h '__DB_HOST__' --port='__DB_PORT__'
