...
docker exec __APP_ID__ npm install -g forever
docker exec -u __USERKEY__ __APP_ID__ ./psh.phar e2e:dump-db
docker exec -u __USERKEY__ __APP_ID__ forever start platform/src/Storefront/Resources/e2e/routes/cypress.js
